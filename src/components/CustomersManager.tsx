...
interface CustomersManagerProps {
  ...
  onGoToPOS?: (phone: string) => void;
  onGoToAppointments?: (phone: string) => void;
...
export default function CustomersManager({ 
  ...
  // Helper for matching phone numbers safely
  ...
  const handleSaveClient = async (e: React.FormEvent) => {
    ...
    const newClient: Client = {
      ...
      account_balance: 0, // Integer cents
      lifetime_value: 0,  // Integer cents
  ...
  // Cross-referenced Datasets for Active Client
        ...
        {!selectedClient ? (
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col border border-slate-200 rounded-2xl bg-white shadow-sm relative">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Identity & Financial Header Card */}
              <div className="flex flex-wrap lg:flex-nowrap gap-6 items-start justify-between">
                <div className="space-y-4">
                  <div>
                    <h2 className="text-2xl font-black text-slate-800 tracking-tight">{selectedClient.full_name}</h2>
                    ...
                    {clientPets.map(pet => (
                      <div key={pet.id} className="p-4 bg-white border border-slate-200 rounded-xl shadow-xs hover:shadow-sm transition-all group flex flex-col justify-between h-full">
                        ...
                        <button 
                          ...
                          className="mt-4 w-full py-1.5 bg-slate-50 hover:bg-indigo-50 border border-slate-200 hover:border-indigo-200 text-slate-600 hover:text-indigo-700 text-[10px] font-extrabold rounded-lg transition-colors cursor-pointer"
                        >
                          View EHR Record
                        </button>
                      </div>
              ...
              {/* 50/50 Split for Financials & Bookings */}
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                    ...
                    {onGoToPOS && (
                      <button onClick={() => onGoToPOS(selectedClient.primary_phone)} className="text-[10px] font-bold text-indigo-600 hover:text-indigo-800 cursor-pointer flex items-center gap-1">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                    ...
                    {onGoToAppointments && (
                      <button onClick={() => onGoToAppointments(selectedClient.primary_phone)} className="text-[10px] font-bold text-indigo-600 hover:text-indigo-800 cursor-pointer flex items-center gap-1">
